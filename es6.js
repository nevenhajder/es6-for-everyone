...
// Returns the first post where the function evaluates to true
const thePost = posts.find(post => post.code === 'VBgtGQcSf');
console.log(thePost);

// Returns the index of the post where the function evaluates to true
const postIndex = posts.findIndex(post => post.code === 'FpTyHQcau');
